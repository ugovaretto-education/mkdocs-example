...
def subtract(a: float | int, b: float | int) -> float:
    ...
    Args:
        a: A number representing the first element in the subtraction.
        b: A number representing the second element in the subtraction.
...
def multiply(a: float | int, b: float | int) -> float:
    ...
    Args:
        a: A number representing the first element in the multiplication.
        b: A number representing the second element in the multiplication.
...
def divide(a: float | int, b: float | int) -> float:
    ...
    Returns:
        A number representing the quotient
